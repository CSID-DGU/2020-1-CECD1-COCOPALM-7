...
public class IncrementOfKeyword {
	...
	public void setCollect_time(String collec_time) {
		this.collect_time = collec_time;
	}
	...
	public String toString() {
		return "IncrementOfKeyword [collect_time=" + collect_time + ", agree_increment="
				+ agree_increment + ", post_increment=" + post_increment + "]";
	}
}
